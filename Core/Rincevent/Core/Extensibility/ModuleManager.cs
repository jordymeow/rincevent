...
namespace Meow.FR.Rincevent.Core.Extensibility
{
    public class ModuleManager
    {
        ...
        {
            _ioModuleList.Add(new Meow.FR.Rincevent.IO.CSV.Module());
            _displayModuleList.Add(new Meow.FR.Rincevent.Display.MiniWindow.Module());
            _displayModuleList.Add(new Meow.FR.Rincevent.Display.Quizz.Module());
            return;
